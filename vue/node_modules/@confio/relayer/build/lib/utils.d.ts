...
import { BlockResultsResponse, ReadonlyDateWithNanoseconds, ValidatorPubkey as RpcPubKey, tendermint34 } from '@cosmjs/tendermint-rpc';
...
export declare function buildConsensusState(header: tendermint34.Header): TendermintConsensusState;
...
export declare function parsePacketsFromBlockResult(result: BlockResultsResponse): Packet[];
