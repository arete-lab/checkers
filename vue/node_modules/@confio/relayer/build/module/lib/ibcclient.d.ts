...
import { AuthExtension, BankExtension, QueryClient, SigningStargateClient, SigningStargateClientOptions, StakingExtension } from '@cosmjs/stargate';
...
export declare function buildCreateClientArgs(src: IbcClient, trustPeriodSec?: number): Promise<CreateClientArgs>;
